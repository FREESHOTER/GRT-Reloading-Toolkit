...
public class CultureFormattingTests
{
    ...
    private static List<string> BareInterpolations(bool cliOnly)
    {
    ...
    {
        var bare = BareInterpolations(cliOnly: false);
        Assert.True(bare.Count == 0,
            "interpolation formats a number per the OS locale:\n  " + string.Join("\n  ", bare));
    }
    ...
    {
        Assert.NotEmpty(BareInterpolations(cliOnly: true));
    }
